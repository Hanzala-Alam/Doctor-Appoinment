...
<head>
    ...
    <style>
        body{
            background:url('image/myappointment.jpg');
        ...
        <div class="row">
            <div class="col-md-12 mt-lg-4">
                <div class="jumbotron bg-dark">
                    <h1 class="text-center text-white">Appointment</h1>
                </div>
            </div>
            <div class="col-md-12">
                <table class="table table-bordered table-dark table-responsive-md table-striped">
                    <tr>
                        <th>Token No</th>
                        <th>Docter</th>
                        <th>Patient</th>
                    ...
                    <?php
                        $select = "select * from Appointment where PatientId = '$pid'";
                        ...
                        if($run){
                            while($res = mysqli_fetch_array($run)){
                                ...
                                if($r){
                                    ...
                                    <td>".$res['StopTime']."</td>
                                    <td>".$res['Fees']."</td>
                                    <td><a href='cancel.php?id=".$res['Id']."' class='btn btn-outline-primary' onclick='return del()'>Cancel</a></td>
                                    </tr>";
                                }
                            }
                        }                         
